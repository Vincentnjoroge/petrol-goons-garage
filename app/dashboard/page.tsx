      ...
      <div className="bg-petrol-black text-white p-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button onClick={() => window.location.href = '/admin'} className="bg-white bg-opacity-10 text-white px-3 py-2 rounded-lg text-sm hover:bg-opacity-20" title="Super Admin">
